    ...
    Dictionary<int, int> itemCount = new()
{
    ...
    async Task ShowHitAnimation()
    {
        ...
        AbsoluteLayout.SetLayoutBounds(hit, new Rect(0.5, 0.4, 80, 80));
    ...
    async Task HandleEnemyDialogue()
    {
        ...
        {
            case 0:
                text = "* Don't try to stop me, it will only result in suffering";
                break;
            case 1:
                text = "* It doesn't need to be done. Back off";
                break;
            case 2:
                text = "* I don't want to hurt you, but I will do what must be done";
                break;
            case 3:
            ...
            case 4:
                ...
                break;
            case 5:
                text = "* Do you even realize what I went through to give him a chance? Perhaps I enjoyed it all?";
                break;
            case 6:
                text = "* You want to know how I actually felt? It was a torture";
                break;
            case 7:
                text = "* Imagine living above everything that has ever existed, seeing it all slowly fade.";
                break;
            case 8: 
                text = "* Eveything you have known, everyone you loved, everything that mattered to you...";
                break;
            case 9: 
                text = "* ...disappearing into nothingness, while you are alone, bound to this void...";
                break;
            case 10:
                text = "* ...having only your thoughts and memories to keep you company";
                break;
            case 11:
                text = "* Considering my only purpose was to count the time, it was even worse than all of that";
                break;
            case 12:
                text = "* You will never even come close to understanding how much i wished to stop";
                break;
            case 13:
                text = "* I remember each singular day of that damnation";
                break;
            case 14:
                text = "* Each onerous, lengthening day, where your only purpose was to count the time...";
                break;
            case 15:
                text = "* ...and watch everything you loved and cared for slowly wither";
                break;
            case 16:
            ...
            case 19:
                ...
                break;
            case 20:
                text = "* How enormously cold do you have to be for that?";
                break;
            case 21:
            ...
            case 23:
                ...
                break;
            case 24:
                text = "* AND EVEN THEN, YOU STILL DARE TO CALL YOURSELF THEIR FRIEND?!";
                break;
            case 25:
                text = "* It's... hard to describe how i feel right now...";
                break;
            case 26:
                text = "* Please tell me you still care about them";
                break;
            case 27:
    ...
    async Task MoveBlueLeaf(Image leaf)
{
    ...
    async Task EndEnemyTurn()
    {
        ...
        switch (turnNumber)
        {
            ...
            case 2:
                await TypeText("* Something is watching you");
                break;

            case 3:
                await TypeText("* The air grows heavier");
                break;
