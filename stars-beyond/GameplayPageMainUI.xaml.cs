...
public partial class GameplayPageMainUI : ContentPage
{
    ...
    ChainSfxService chainSfx;
    public GameplayPageMainUI(MusicService music, SfxService sfx, ChainSfxService chain)
	{
        InitializeComponent();
        ...
        Loaded += (s, e) =>
        {
            StartAnimatedBackground(1.2, 35);
        };
        OnPhase1Start();
    ...
    int turnNumber = 0;
    int regainedMemories = 0;
    bool useSpecialAttackPack = false;
    bool spareTurnedYellow = false;
    List<Func<Task>> specialAttackPack = null;
    ...
    Dictionary<int, int> itemCount = new()
{
    ...
    bool forceRebuildAttackPool = false;
    int enemyMaxHp = 1650;
    int enemyHp = 1650;
    ...
    {
        base.OnAppearing();
        await musicService.Play("GUARDIAN.mp3");
        StartIdleAnimation();
        if (introPlayed)
            return;
    ...
    async Task StartIntroDialog()
    {
        ...
        await TypeText("* The void feels eerily still, considering the circumstances.");
    }
    ...
    private void StartIdleAnimation()
    {
        ...
        _ = RunIdleLoop(_idleCts.Token);
    }

    private async Task RunIdleLoop(CancellationToken token)
    {
        double t = 0;
        ...
        {
            // p³ynna sinusoida
            double x = Math.Sin(t) * 14;   // lewo/prawo
            double y = Math.Sin(t * 2) * 10; // góra/dó³ (szybsze, subtelne)

            CharacterImage.TranslationX = x;
            CharacterImage.TranslationY = y;

            t += 0.06; // prêdkoœæ animacji
    ...
    async Task ShowEnemyDialogue(string text, int duration = 2000)
    {
    ...
    async void OnAttackTap(object sender, EventArgs e)
    {
        ...
        if (isPerfectHit)
        {
            _ = sfxService.Play("hit_critical.mp3");
            wasPerfectHit = true;
            damage = 50;
        }
        else
        {
            _ = sfxService.Play("hit_normal.mp3");
            wasPerfectHit = false;
        }
    ...
    async Task ShowHitAnimation()
    {
        ...
        AbsoluteLayout.SetLayoutBounds(hit, new Rect(0.5, 0.4, 250, 100));
        AbsoluteLayout.SetLayoutFlags(hit, AbsoluteLayoutFlags.PositionProportional);
        RootLayout.Children.Add(hit);
        StartFrameAnimation(hit, "hit_", 4, 120);
        await Task.Delay(100);
        _ = sfxService.Play("enemy_hit.mp3");
        await Task.Delay(300);
        if (wasPerfectHit)
        {
            _ = sfxService.Play("enemy_damaged_strong.mp3");
            wasPerfectHit = false;
        }
        else
        {
            _ = sfxService.Play("enemy_damaged.mp3");
        }
        await Task.Delay(180);
        if (RootLayout.Children.Contains(hit))
            RootLayout.Children.Remove(hit);
    }
    ...
    async Task HandleEnemyDialogue()
    {
        ...
        switch (turnNumber)
        {
            case 0:
                ...
                break;
            case 1:
                text = "* What goal do you wish to achieve through this?";
                break;
            case 2:
                text = "* I don't want to hurt you, but I will not withdraw now.";
                break;
            case 3:
                text = "* Why are you doing this? I told you it's for the better of a person you apparently care so much about!";
                break;
            case 4:
                text = "* What is so hard to understand? I am doing this purely to help Melch!";
                break;
            case 5:
                text = "* Do you even realize what I went through to give him a chance? Perhaps you think I enjoyed it?";
                break;
            case 6:
                text = "* Maybe you seek to know how I actually felt?";
                break;
            case 7:
                text = "* Imagine living beyond everything that has ever existed, seeing it all slowly fade.";
                break;
            case 8: 
                text = "* Everything you have known, everyone you loved, everything that mattered to you...";
                break;
            case 9: 
                text = "* ...disappearing into nothingness, whilst being alone, bound to this void...";
                break;
            case 10:
                text = "* ...having only your thoughts and memories to keep you company.";
                break;
            case 11:
                text = "* On top of everything, my only sense was time, which made it so much worse.";
                break;
            case 12:
                text = "* You will never even come close to understanding how much I wished to... die. Like everyone else.";
                break;
            case 13:
                text = "* I remember each singular day of the damnation that was brought down on me.";
                break;
            case 14:
                text = "* Each onerous, lengthening day, where all I could do was to stare";
                break;
            case 15:
                text = "* ...and watch everything I loved and cared for slowly wither away.";
                break;
            case 16:
                text = "* It has been an eternity since I last could have said a word to someone else.";
                break;
            case 17:
                text = "* And now, despite my thorough, exhaustive explanation...";
                break;
            case 18:
                text = "* ... you still want to subject them to this fate?";
                break;
            case 19:
                text = "* A burden no mind should ever have to endure";
                break;
            case 20:
                text = "* How enormously cold and insensitive do you have to be for that?";
                break;
            case 21:
                text = "* It leads me to believe you possess no interest towards their well-being.";
                break;
            case 22:
                text = "* To put an innocent CHILD throught such torment without any reflections?!";
                break;
            case 23:
                text = "* To tear apart their harmless and kind soul, subject them to what can only be described as hell.";
                break;
            case 24:
                text = "* AND EVEN NOW, YOU STILL DARE TO CALL YOURSELF THEIR FRIEND?!";
                break;
            case 25:
                text = " ...";
                break;
            case 26:
                text = "* It's... hard to describe how i feel right now...";
                break;
            case 27:
                text = "* Please tell me that you still care about them. That I am percieving it wrong.";
                break;
            case 28:
                text = "* I understand that trusting me after what I did is going to be difficult...";
                break;
            case 29:
                text = "* ...but it is the only way to spare them from this madness.";
                break;
            case 30:
                text = "* The only way to spare... us...";
                break;
            default:
                text = "* ...";
                break;
    ...
    async void RunAct(int index)
    {
        ...
        {
            case 0:
                _ = sfxService.Play("dialog_options.mp3");
            ...
            case 2:
                _ = sfxService.Play("dialog_options.mp3");
                if (connectProgress >= 3)
                {
                    connectProgress = 0;
                    useSpecialAttackPack = true;
                    specialAttackPack = BlueLeafPack();
                    forceRebuildAttackPool = true;
                    await TypeText("* Melch is trying to regain control... \n* Help them by collecting blue leaves!");
                    return;
                } else
                {
                    await TypeText("* You tried to mentally connect with Melch... \n* you couldn't locate his faint presence");
                }
                break;
        }
    }
    ...
    string GetOption1Text()
    {
        switch (connectProgress)
        {
            case 1:
                connectProgress++;
                return "* You tried to reach out to Melch... \n* Their voice seems closer than before... \n* You can almost connect to Melch!";
            case 2:
                connectProgress++;
                return "* You tried to reach out to Melch... \n* You can now connect to them for a short period of time!";
            case 3:
                return "* You can already connect!";
            default:
                connectProgress++;
                return "* You tried to reach out to Melch... \n* You caught a glimpse of their voice calling you! \n* You are closer to connecting to them!";
    ...
    async Task RunMercy(int index)
    {
        switch (index)
        {
            case 0: // SPARE
                _ = sfxService.Play("dialog_options.mp3");
                if (regainedMemories >= 100)
                {
                    winType = WinType.Pacifist;
    ...
    async Task GoToWinPage()
    {
        ...
        await Shell.Current.GoToAsync("//WinPage", new Dictionary<string, object>
        {
            ["WinType"] = winType
        });
    }
    void UpdateSpareColor()
    {
        if (regainedMemories >= 100 && !spareTurnedYellow)
        {
            spareTurnedYellow = true;

            SpareButton.TextColor = Colors.Yellow; // albo BackgroundColor
        }
    }
    async Task FadeOutAndGoToMenu()
    {
        _ = musicService.FadeOut(1000);
    ...
    async Task UseItem(int index)
    {
        ...
        switch (index)
        {
            case 0: // Chocolate d12 dice
                {
                    ...
                    _ = sfxService.Play("item_use.mp3");
                    await Task.Delay(50);
                    _ = sfxService.Play("heal.mp3");
                    await TypeText(text);
                    break;
                }
            ...
            case 3: // powdered anger
                damageBoostActive = true;
                _ = sfxService.Play("item_use.mp3");
                await Task.Delay(50);
                _ = sfxService.Play("power_up.mp3");
                if (random.Next(100) < 99)
                {
                    await TypeText("* The powder fills you with uncontainable rage. \n* Your damage has been severly boosted!");
                }
                else
                {
                    await TypeText("* Too much Twitter");
                }
                break;
        }
    ...
    async void StartEnemyTurn()
    {
        ...
        if (forceRebuildAttackPool)
        {
            attacks = specialAttackPack;
            forceRebuildAttackPool = false;
            useSpecialAttackPack = true;
        }
    ...
    {
        if (useSpecialAttackPack && specialAttackPack != null)
            return specialAttackPack;
    ...
    void StartAnimatedBackground(double scale = 1.2, int frameMs = 35)
    {
        if (AnimatedBackground == null)
            return;
        AnimatedBackground.Scale = scale;
    ...
    async Task SpawnChain(string direction, double speed = BaseChainSpeed, double? fixedX = null, double? fixedY = null, bool stopAfterInitialMove = false)
    {
        ...
        img.IsVisible = true;
        _ = sfxService.Play("chain_throw.mp3");
    ...
    void ClearChains()
    {
        chainSoundRunning = false;
        _ = chainSfx.FadeOut(400);
    ...
    bool chainSoundRunning = false;

    void EnsureChainSound()
    {
        if (!chainSoundRunning)
        {
            chainSoundRunning = true;
            _ = chainSfx.Start();
        }
    }
    async Task Attack_BlueLeaf()
    {
        isBlueLeafMinigame = true;
        currentState = TurnState.AttackMinigame;
        ...
        var leafTimer = Dispatcher.CreateTimer();
        leafTimer.Interval = TimeSpan.FromMilliseconds(300);

        leafTimer.Tick += (s, e) =>
        {
            if (!isBlueLeafMinigame)
            {
                leafTimer.Stop();
                return;
            }
        ...
        isBlueLeafMinigame = false;
        gameRunning = false;

        StopGameLoop();

        await TypeText($"* You recovered {regainedMemories} memories...");
    }
    void SpawnBlueLeaf()
    {
        var leaf = new Image
        {
            Source = "blue_leaf.png",
            WidthRequest = BulletSize * 4,
            HeightRequest = BulletSize * 4
        };

        double x = random.NextDouble() * (BattleField.Width - BulletSize);
        double y = -BulletSize;

        AbsoluteLayout.SetLayoutBounds(leaf, new Rect(x, y, BulletSize, BulletSize));
        BattleField.Children.Add(leaf);

        _ = MoveBlueLeaf(leaf);
    }
    async Task MoveBlueLeaf(Image leaf)
{
    while (BattleField.Children.Contains(leaf) && isBlueLeafMinigame)
    {
        leaf.TranslationY += BulletSpeed * 0.4;

        if (IsColliding(Player, leaf))
        {
            BattleField.Children.Remove(leaf);
            regainedMemories++;
                UpdateSpareColor();
                continue;
        }

        if (leaf.TranslationY > BattleField.Height + 50)
        {
            BattleField.Children.Remove(leaf);
            break;
        }
    ...
    async Task EndEnemyTurn()
    {
        ...
        useSpecialAttackPack = false;
        specialAttackPack = null;
        ActionButtons.IsVisible = true;
        DialogLabel.IsVisible = true;
        switch (turnNumber)
        {
            ...
            case 3:
                await TypeText("* The wind is picking up.");
                break;
            case 4:
                await TypeText("* The wind is picking up.");
                break;
            case 5:
                ...
                break;
            case 6:
                await TypeText("* The air grows colder and heavier.");
                break;
            case 7:
                await TypeText("* The air grows colder and heavier.");
                break;
    ...
    void DealDamage(int damage)
    {
        ...
        if (damage >= 1)
        {
            double x = CharacterImage.TranslationX + CharacterImage.Width / 2 - 40;
            double y = CharacterImage.TranslationY + CharacterImage.Height / 2 - 40;
            _ = ShowHitAnimation();
        ...
        if (enemyHp <= 0)
        {
            _ = ShowHitAnimation();
            _ = ShowDamageText(damage);
            winType = WinType.Kill;
            _ = GoToWinPage();
        }
    }
    void CheckPhaseTransition()
    {
        BattlePhase targetPhase = currentPhase;

        // HP logic
        if (enemyHp <= 550)
            targetPhase = BattlePhase.Phase3;
        else if (enemyHp <= 1100)
            targetPhase = BattlePhase.Phase2;

        // Blue Leaf logic (override / dodatkowy progress)
        if (regainedMemories >= 67)
            targetPhase = BattlePhase.Phase3;
        else if (regainedMemories >= 33 && targetPhase == BattlePhase.Phase1)
            targetPhase = BattlePhase.Phase2;
        ...
        if (targetPhase != currentPhase)
        {
            ...
            if (currentPhase == BattlePhase.Phase2)
                OnPhase2Start();
            else if (currentPhase == BattlePhase.Phase3)
                OnPhase3Start();
        }
    }
    void OnPhase1Start()
    ...
    async void TakeDamage(int dmg)
    {
        ...
        playerHp -= dmg;
        _ = sfxService.Play("player_hit.mp3");
        if (overhealActive)
        {
    ...
    public async Task RestartFromDeath()
    {
        ...
        isInvincible = false;
        isInputLocked = false;
        spareTurnedYellow = false;
        SpareButton.TextColor = Colors.White;
        try
        {
            gameLoop?.Stop();
            spawnTimer?.Stop();
        ...
        DialogLabel.IsVisible = true;
        DialogLabel.Text = "* The void feels eerily still, considering the circumstances.";
